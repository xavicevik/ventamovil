...
const submit = () => {
    ...
    })).post(route('loginapp.authenticate'), {
...
<template>
    <Head title="Log in App" />

    <JetAuthenticationCard class="ml-4 mr-4">
        <template #logo>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <JetButton class="mx-auto" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Ingresar
                </JetButton>
            </div>
        </form>
